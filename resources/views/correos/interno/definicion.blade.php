...
<div style="color: #718096; font-size: 16px;">
  ...
  <br><br>
  Espero que estés teniendo un buen día. Se informa que hemos subido con éxito el archivo '<strong>{{$datos->folio}} Definición de requerimiento</strong>' a la plataforma. Este archivo es crucial para nuestro proceso, y agradeceríamos que lo verifiquen.
  <br><br>
