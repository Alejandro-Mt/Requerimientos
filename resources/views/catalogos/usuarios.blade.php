          ...
          <div>
            ...
            @foreach ($users as $user)
              <div class="row media">
                ...
                <div class="col-md-2">
                  <div class="mb-3 text-center">
                    <input type="checkbox" class="form-check-input" disabled {{ $user->usrdata->activo == '1' ? 'checked' : '' }}>
                  </div>
                </div>
                <div class="col-md-2 action-btn">
                  <div class="mb-3 text-center">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" name="activo" {{ $user->usrdata->activo == '1' ? 'checked' : '' }}>
