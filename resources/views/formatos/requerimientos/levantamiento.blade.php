            ...
            <div>
                ...
                <section>
                    ...
                    <div class="form-group row">
                        <label for="folio"
                            class="col-sm-2 text-end control-label col-form-label">Bitrix/ID</label>
                        <div class="col-md-3">
                            @foreach ($registros as $registro)
                                <input name="folio" type="text" class="required form-control  @error ('folio') is-invvalid @enderror" 
                                    value={{$registro->bitrix}} readonly="readonly">                                  
                            @endforeach
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="d-none"> 
                        <input type="text" name="estatus" value="En Construccion" visible="false">
                    </div>
