                    ...
                    <section>
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class= 'col-md-8'>
                                    <div class="input-group">
                                        <input name = "fechaCompReqR" @foreach ($previo as $ant) @if($ant->fechaCompReqR == null) value="{{null}}" @else value="{{date('d-m-20y',strtotime($ant->fechaCompReqR))}}" @endif @endforeach type="text" class="form-control mydatepicker" id="datepicker-autoclose" placeholder="DD/MM/AAAA" data-date-format="dd-mm-yyyy">
