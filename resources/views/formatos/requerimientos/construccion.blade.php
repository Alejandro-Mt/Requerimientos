                    ...
                    <section>
                       <!-- <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            class="col-sm-2 text-end control-label col-form-label">Inicio de Construccion*</label>
                            <div class= 'col-md-8'>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="required form-control @error('motivopausa') is-invalid @enderror" 
                                        name="motivopausa" placeholder="motivopausa" required autofocus>
                                    @error('motivopausa')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="d-none"> 
                                <input type="text" name="estatus" value="Construir" visible="false">
                        </div>
