              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="button-group">
                    <button
                      type="button"
                      class="btn btn-lg px-4 fs-4 btn-light-success text-success font-medium"
                      id="ts-success"
                    >
                      Success
                    </button>
                    <button
                      type="button"
                      class="btn btn-lg px-4 fs-4 btn-light-info text-info font-medium"
                      id="ts-info"
                    >
                      Info
                    </button>
                    <button
                      type="button"
                      class="btn btn-lg px-4 fs-4 btn-light-warning text-warning font-medium"
                      id="ts-warning"
                    >
                      Warning
                    </button>
                    <button
                      type="button"
                      class="btn btn-lg px-4 fs-4 btn-light-danger text-danger font-medium"
                      id="ts-error"
                    >
                      Error
                    </button>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="button-group">
                    <button
                      type="button"
                      class="btn btn-lg px-4 fs-4 btn-light-primary text-primary font-medium"
                      id="slide-toast"
                    >
                      slideDown - slideUp
                    </button>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="button-group">
                <button
                  type="button"
                  class="btn btn-lg fs-4 px-4 btn-light-primary text-primary font-medium"
                  id="pos-top-left"
                >
                  Top Left
                </button>
                <button
                  type="button"
                  class="btn btn-lg fs-4 px-4 btn-light-success text-success font-medium"
                  id="pos-top-center"
                >
                  Top Center
                </button>
                <button
                  type="button"
                  class="btn btn-lg fs-4 px-4 btn-light-warning text-warning font-medium"
                  id="pos-top-right"
                >
                  Top Right
                </button>
                <button
                  type="button"
                  class="btn btn-lg fs-4 px-4 btn-light-danger text-danger font-medium"
                  id="pos-top-full"
                >
                  Top Full Width
                </button>
