...
!function(e, t) {
    ...
    var i, o = function() {
        ...
        return e.prototype.setGutters = function(e) {
            e ? o(this.gutters, e) : this.gutters = {},
            this.updateSize()
        }
        ,
        ...
        function r(r, n) {
            ...
            return i.reportScroll = function() {
                i.isScrolling || i.reportScrollStart(),
                i.trigger("scroll"),
                i.isMoving = !0,
                i.requestMovingEnd()
            }
            ...
            i.reportScrollStart = function() {
                ...
                i.trigger("scrollStart", i.isTouching))
            }
            ,
            ...
            i.reportTouchEnd = function() {
                i.isTouching && (i.isTouching = !1,
                i.isTouchScrollEnabled && i.unbindPreventTouchScroll(),
                i.isMoving || i.reportScrollEnd())
            }
            ,
            i.isScrolling = !1,
            i.isTouching = !1,
        ...
        r.prototype.unbindPreventTouchScroll = function() {
            this.preventTouchScrollHandler && (this.el.removeEventListener("touchmove", this.preventTouchScrollHandler),
        ...
        r.prototype.reportScrollEnd = function() {
            this.isScrolling && (this.trigger("scrollEnd"),
            this.isScrolling = !1)
        }
        ,
    ...
    function a() {
        return i || (i = function() {
            ...
            r.scrollLeft > 0 ? e = "positive" : (r.scrollLeft = 1,
            e = r.scrollLeft > 0 ? "reverse" : "negative");
            return t.removeElement(r),
            e
        }())
    }
    ...
    var c = function() {
        function e(e, r, n) {
            ...
            "clipped-scroll" === e && (e = "scroll",
            this.isHScrollbarsClipped = !0),
            "clipped-scroll" === r && (r = "scroll",
            this.isVScrollbarsClipped = !0),
            this.enhancedScroll = new s(e,r),
            n.appendChild(this.el = t.createElement("div", {
        ...
        e.prototype.updateSize = function() {
            ...
            this.isVScrollbarsClipped && (i.marginLeft = -n.scrollbarLeft,
            i.marginRight = -n.scrollbarRight),
            this.isHScrollbarsClipped && (i.marginBottom = -n.scrollbarBottom),
            t.applyStyle(r, i),
            !this.isHScrollbarsClipped && "hidden" !== e.overflowX || !this.isVScrollbarsClipped && "hidden" !== e.overflowY || n.scrollbarLeft || n.scrollbarRight || n.scrollbarBottom ? r.classList.remove("fc-no-scrollbars") : r.classList.add("fc-no-scrollbars")
        }
        ,
        ...
        e.prototype.getScrollbarWidths = function() {
            ...
            return this.isVScrollbarsClipped && (e.left = 0,
            e.right = 0),
      ...
      , d = function() {
        ...
        e.prototype.update = function() {
            ...
            )), n = 0, i = 0, o = 0, l = 0, s = 0, a = r; s < a.length; s++)
                e = a[s],
                n = Math.max(n, e.left),
                i = Math.max(i, e.right),
                o = Math.max(o, e.top),
                l = Math.max(l, e.bottom);
            for (t = 0; t < this.scrollers.length; t++) {
                var c = this.scrollers[t];
                e = r[t],
                c.enhancedScroll.canvas.setGutters("horizontal" === this.axis ? {
                    left: n - e.left,
                    right: i - e.right
                } : {
                    top: o - e.top,
      ...
      , h = function() {
        function e(e, t, r) {
            this.headerScroller = new c("clipped-scroll","hidden",e),
            this.bodyScroller = new c("auto",r,t),
            this.scrollJoiner = new d("horizontal",[this.headerScroller, this.bodyScroller])
        }
        return e.prototype.destroy = function() {
      ...
      , u = function(e) {
        ...
        r.prototype.renderDates = function(e) {
            for (var r = this.context, n = r.dateEnv, i = r.theme, o = e.cellRows, l = o[o.length - 1], s = t.asRoughMs(e.labelInterval) > t.asRoughMs(e.slotDuration), a = t.isSingleDay(e.slotDuration), c = "<colgroup>", d = e.slotCnt - 1; d >= 0; d--)
                c += "<col/>";
            c += "</colgroup>",
            c += "<tbody>";
            for (var h = 0, u = o; h < u.length; h++) {
                ...
                for (var f = 0, m = p; f < m.length; f++) {
                    ...
                    g.isWeekStart && v.push("fc-em-cell"),
                    a && (v = v.concat(t.getDayClasses(g.date, this.props.dateProfile, this.context, !0))),
                    c += '<th class="' + v.join(" ") + '" data-date="' + n.formatIso(g.date, {
      ...
      , p = function(e) {
        ...
        ,
        r.prototype.renderDates = function(e) {
            for (var r = this.context, n = r.calendar, i = r.view, o = r.theme, l = r.dateEnv, s = e.slotDates, a = e.isWeekStarts, c = '<table class="' + o.getClass("tableGrid") + '"><colgroup>', d = 0; d < s.length; d++)
                c += "<col/>";
            c += "</colgroup>",
            c += "<tbody><tr>";
            for (d = 0; d < s.length; d++)
                c += this.slatCellHtml(s[d], a[d], e);
            c += "</tr></tbody></table>",
            this.el.innerHTML = c,
        ...
        r.prototype.slatCellHtml = function(e, r, n) {
            var i, o = this.context, l = o.theme, s = o.dateEnv;
            return n.isTimeScale ? (i = []).push(t.isInt(s.countDurationsBetween(n.normalizedRange.start, e, n.labelInterval)) ? "fc-major" : "fc-minor") : (i = t.getDayClasses(e, this.props.dateProfile, this.context)).push("fc-day"),
            i.unshift(l.getClass("widgetContent")),
            r && i.push("fc-em-cell"),
            '<td class="' + i.join(" ") + '" data-date="' + s.formatIso(e, {
    ...
    function m(e, r, n, i) {
        ...
        !function(e, r, n) {
            ...
            if (e.labelInterval) {
                n.countDurationsBetween(i.start, i.end, e.labelInterval) > t.config.MAX_TIMELINE_SLOTS && (console.warn("slotLabelInterval results in too many cells"),
                e.labelInterval = null)
            }
            if (e.slotDuration) {
                n.countDurationsBetween(i.start, i.end, e.slotDuration) > t.config.MAX_TIMELINE_SLOTS && (console.warn("slotDuration results in too many cells"),
                e.slotDuration = null)
            }
            if (e.labelInterval && e.slotDuration) {
                var o = t.wholeDivideDurations(e.labelInterval, e.slotDuration);
        ...
        function(e, r, n) {
            var i = r.currentRange
              , o = e.slotDuration;
            if (!o) {
                for (var l = S(e, r, n), s = 0, a = f; s < a.length; s++) {
                    var c = a[s]
                ...
                if (o)
                    n.countDurationsBetween(i.start, i.end, o) > 200 && (o = null);
                o || (o = l),
                e.slotDuration = o
            }
        }(o, e, r);
        var l = n.slotLabelFormat
          , s = Array.isArray(l) ? l : null != l ? [l] : function(e, r, n, i) {
            var o, l, s = e.labelInterval, a = t.greatestDurationDenominator(s).unit, c = i.weekNumbers, d = o = l = null;
            "week" !== a || c || (a = "day");
            switch (a) {
            case "year":
                d = {
        ...
        o.largeUnit = a,
        o.emphasizeWeeks = t.isSingleDay(o.slotDuration) && b("weeks", e, r) >= 2 && !n.businessHours;
        var d, h, u = n.snapDuration;
        u && (d = t.createDuration(u),
        h = t.wholeDivideDurations(o.slotDuration, d)),
        null == h && (d = o.slotDuration,
        h = 1),
        o.snapDuration = d,
        o.snapsPerSlot = h;
        var p = t.asRoughMs(e.maxTime) - t.asRoughMs(e.minTime)
          , m = g(e.renderRange.start, o, r)
          , D = g(e.renderRange.end, o, r);
        o.isTimeScale && (m = r.add(m, e.minTime),
        D = r.add(t.addDays(D, -1), e.maxTime)),
        o.timeWindowMs = p,
        o.normalizedRange = {
            start: m,
            end: D
        ...
        for (C = m; C < D; )
            ...
            R.push(T),
            k.push(x)) : R.push(T + .5),
            C = r.add(C, o.snapDuration),
            x++;
        return o.snapDiffToIndex = R,
        o.snapIndexToDiff = k,
        o.snapCnt = T + 1,
        ...
        o.cellRows = function(e, r, n) {
            for (var i = e.slotDates, o = e.headerFormats, l = o.map((function(e) {
                ...
                for (var c = i[a], d = e.isWeekStarts[a], h = 0; h < o.length; h++) {
                    ...
                    if (m) {
                        var v = r.format(c, u);
                        f && f.text === v ? f.colspan += 1 : g = E(c, v, s[h], n, r)
    ...
    function g(e, r, n) {
        var i = e;
        return r.isTimeScale || (i = t.startOfDay(i),
        r.largeUnit && (i = n.startOf(i, r.largeUnit))),
        i
    }
    function v(e, r, n, i) {
        if (i.isHiddenDay(e))
    ...
    function S(e, r, n) {
        ...
        if (!o) {
            ...
            if (e.slotDuration) {
                ...
                for (var h = 0, u = f; h < u.length; h++) {
                    if (l = u[h],
                    o = t.createDuration(l),
                    n.countDurationsBetween(i.start, i.end, o) >= 18)
                        break
                }
            e.labelInterval = o
        }
    ...
    function b(e, r, n) {
        var i = r.currentRange
          , o = null;
        return "years" === e ? o = n.diffWholeYears(i.start, i.end) : "months" === e || "weeks" === e ? o = n.diffWholeMonths(i.start, i.end) : "days" === e && (o = t.diffWholeDays(i.start, i.end)),
        o || 0
    }
    ...
    var D, w = function() {
        ...
        e.prototype.unrender = function() {
            this.arrowEl && t.removeElement(this.arrowEl),
            this.lineEl && t.removeElement(this.lineEl)
        }
        ,
        e
    }(), C = -1 !== (D = t.htmlToElement('<div style="position:-webkit-sticky;position:sticky"></div>').style.position).indexOf("sticky") ? D : null, T = /Edge/.test(navigator.userAgent), x = "-webkit-sticky" === C, R = function() {
        function e(e, r, n) {
            var i = this;
            this.usingRelative = null,
            this.updateSize = function() {
                var e = Array.prototype.slice.call(i.scroller.canvas.el.querySelectorAll(".fc-sticky"))
                  , r = i.queryElGeoms(e)
                ...
                i.usingRelative ? function(e, r, n) {
                    ...
                    e.forEach((function(e, i) {
                        var o = 0;
                        "center" === r[i].intendedTextAlign && (o = (n - r[i].elWidth) / 2,
                        "center" === r[i].computedTextAlign && (e.setAttribute("data-sticky-center", ""),
            ...
            ,
            this.scroller = e,
            this.usingRelative = !C || T && r || (T || x) && n,
        ...
        e.prototype.queryElGeoms = function(e) {
            for (var r = this.scroller.canvas.el.getBoundingClientRect(), n = [], i = 0, o = e; i < o.length; i++) {
                var l = o[i]
                  ...
                  , h = d
                  , u = null;
                "sticky" !== c.position && (u = t.translateRect(a, -r.left - (parseFloat(c.left) || 0), -r.top - (parseFloat(c.top) || 0))),
                l.hasAttribute("data-sticky-center") && (h = "center"),
                n.push({
                    parentBound: s,
                    naturalBound: u,
                    elWidth: a.width,
        ...
        e.prototype.computeElDestinations = function(e, t) {
            ...
            return e.map((function(e) {
                var t, o, l = e.elWidth, s = e.elHeight, a = e.parentBound, c = e.naturalBound;
                ...
                return t = Math.min(t, a.right - l),
                t = Math.max(t, a.left),
                o = n,
                o = Math.min(o, a.bottom - s),
                {
                    left: t,
    ...
    var k = function(e) {
        function r(r, n) {
            ...
            return i.renderSkeleton = t.memoizeRendering(i._renderSkeleton, i._unrenderSkeleton),
            i.layout = new h(r,n,"auto"),
            i
        }
        return n(r, e),
        r.prototype.render = function(e, t) {
            var r = this.tDateProfile = m(e.dateProfile, t.dateEnv, t.options, e.dateProfileGenerator);
        ...
        r.prototype._renderSkeleton = function(e) {
            ...
            this.headStickyScroller = new R(r,e.isRtl,!1),
            this.bodyStickyScroller = new R(n,e.isRtl,!1),
            this.header = new u(r.canvas.contentEl),
            this.slats = new p(n.canvas.bgEl),
            this.nowIndicator = new w(r.canvas.el,n.canvas.el)
        }
        ,
        ...
        r.prototype.getNowIndicatorUnit = function(e, r) {
            var n = this.context
              , i = this.tDateProfile = m(e, n.dateEnv, n.options, r);
            if (i.isTimeScale)
                return t.greatestDurationDenominator(i.slotDuration).unit
        }
        ,
        ...
        r.prototype.computeSlotWidth = function() {
            ...
            return "" === e && (e = this.computeDefaultSlotWidth(this.tDateProfile)),
            e
        }
        ,
        r.prototype.computeDefaultSlotWidth = function(e) {
            ...
            return l && (l = parseInt(l, 10)) && (o = Math.max(o, l)),
            o
        }
        ,
        r.prototype.applySlotWidth = function(e) {
            var t = this.layout
              ...
              , o = "";
            if ("" !== e) {
                n = (e = Math.round(e)) * r.slotDates.length,
                i = "",
                o = e;
                var l = t.bodyScroller.enhancedScroll.getClientWidth();
                l > n && (i = l,
                n = "",
                o = Math.floor(l / r.slotDates.length))
            }
            ...
            "" !== o && this.header.slatColEls.slice(0, -1).concat(this.slats.slatColEls.slice(0, -1)).forEach((function(e) {
                e.style.width = o + "px"
            }
            ))
        }
        ...
        r.prototype.computeDateSnapCoverage = function(e) {
            ...
            return t.isInt(o) ? o += n - i : o = Math.ceil(o),
            o
        }
        ,
        ...
        r.prototype.computeDateScroll = function(e) {
            var r = this.context
              ...
              , l = 0;
            return o && (l = this.dateToCoord(n.add(t.startOfDay(o.activeRange.start), e)),
            !i && l && (l += 1)),
            {
                left: l
            }
        ...
        r.prototype.applyDateScroll = function(e) {
            ...
            this.layout.headerScroller.enhancedScroll.setScrollLeft(e.left || 0)
        }
        ,
        r
    }(t.Component)
      , z = function(e) {
        ...
        r.prototype.attachSegs = function(e, r) {
            ...
            r && this.el.classList.add("fc-mirror-container"),
    ...
    function I(e) {
        return null == e.top && (e.top = M(e.above)),
        e.top + e.height
    }
    function P(e, t) {
    ...
    var L = function(e) {
      ...
      , H = function(e) {
        function r(r, n, i) {
            ...
            o.slicer = new W,
            o.renderEventDrag = t.memoizeRendering(o._renderEventDrag, o._unrenderEventDrag),
            o.renderEventResize = t.memoizeRendering(o._renderEventResize, o._unrenderEventResize),
            o.fgContainerEl = r,
            o.timeAxis = i;
            var l = o.fillRenderer = new L(n,i)
              , s = o.eventRenderer = new z(r,i);
            return o.mirrorRenderer = new z(r,i),
            o.renderBusinessHours = t.memoizeRendering(l.renderSegs.bind(l, "businessHours"), l.unrender.bind(l, "businessHours")),
            o.renderDateSelection = t.memoizeRendering(l.renderSegs.bind(l, "highlight"), l.unrender.bind(l, "highlight")),
            o.renderBgEvents = t.memoizeRendering(l.renderSegs.bind(l, "bgEvent"), l.unrender.bind(l, "bgEvent")),
            o.renderFgEvents = t.memoizeRendering(s.renderSegs.bind(s), s.unrender.bind(s)),
        ...
        r.prototype.render = function(e, t) {
            ...
            this.renderBusinessHours(t, n.businessHourSegs),
            this.renderDateSelection(t, n.dateSelectionSegs),
            this.renderBgEvents(t, n.bgEventSegs),
            this.renderFgEvents(t, n.fgEventSegs),
            this.renderEventSelection(n.eventSelection),
            this.renderEventDrag(n.eventDrag),
            this.renderEventResize(n.eventResize)
        }
        ,
        r.prototype.destroy = function() {
            e.prototype.destroy.call(this),
        ...
        r.prototype._renderEventResize = function(e) {
            if (e) {
                ...
                this.fillRenderer.renderSegs("highlight", this.context, t),
                this.mirrorRenderer.renderSegs(this.context, e.segs, {
                    isDragging: !0,
                    sourceSeg: e.sourceSeg
                })
      ...
      , W = function(e) {
        ...
        r.prototype.sliceRange = function(e, r) {
            var n = r.tDateProfile
              ...
              , s = function(e, r, n) {
                if (!r.isTimeScale && (e = t.computeVisibleDayRange(e),
                r.largeUnit)) {
                    var i = e;
                    ((e = {
            ...
            if (r.computeDateSnapCoverage(s.start) < r.computeDateSnapCoverage(s.end)) {
                ...
                c && a.push({
                    ...
                    isStart: c.start.valueOf() === s.start.valueOf() && v(c.start, n, o, l),
                    isEnd: c.end.valueOf() === s.end.valueOf() && v(t.addMs(c.end, -1), n, o, l)
                })
            }
            return a
        }
      ...
      , A = function(e) {
        function r() {
            ...
            return r.renderSkeleton = t.memoizeRendering(r._renderSkeleton, r._unrenderSkeleton),
            r.startInteractive = t.memoizeRendering(r._startInteractive, r._stopInteractive),
            r
        }
        return n(r, e),
        r.prototype._startInteractive = function(e) {
        ...
        r.prototype.render = function(t, r) {
            ...
            this.lane.receiveProps(o({}, t, {
                nextDayThreshold: this.context.nextDayThreshold
            }), r),
            this.startNowIndicator(t.dateProfile, t.dateProfileGenerator)
        }
        ,
        r.prototype.destroy = function() {
        ...
        r.prototype._renderSkeleton = function(e) {
            ...
            !1 === e.options.eventOverlap && this.el.classList.add("fc-no-overlap"),
            this.el.innerHTML = this.renderSkeletonHtml(),
            this.timeAxis = new k(this.el.querySelector("thead .fc-time-area"),this.el.querySelector("tbody .fc-time-area")),
            this.lane = new H(this.timeAxis.layout.bodyScroller.enhancedScroll.canvas.contentEl,this.timeAxis.layout.bodyScroller.enhancedScroll.canvas.bgEl,this.timeAxis)
        }
        ,
        r.prototype._unrenderSkeleton = function() {
        ...
        ,
        r.prototype.updateSize = function(e, t, r) {
            this.timeAxis.updateSize(e, t, r),
