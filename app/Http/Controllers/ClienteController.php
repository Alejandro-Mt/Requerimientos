    ...
    public function document($folio)
    {
        ...
        $registros= registro::
            select('registros.*',
              ...
              'a.updated_at as analisis',
              'c.updated_at as construccion',
              'li.updated_at as liberacion',
              ...
              DB::raw('CalcDias(ifnull(l.fechaaut, p.created_at), c.updated_at) as cons'),
              DB::raw('CalcDias(c.updated_at, li.updated_at) as lib'),
              DB::raw('CalcDias(li.updated_at, i.updated_at) as imp'),
