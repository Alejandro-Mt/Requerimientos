...
class TestingController extends Controller
{
    ...
    public function create(request $data){
        ...
        $this->validate($data, ['fechaInicioReal' => "required|date|after_or_equal:{$registro->construccion->fechaFinReal}"]);
        if($data['fechaInicioReal']<>NULL){$fechaInicioReal=date("y/m/d H:i:s", strtotime($data['fechaInicioReal']));}else{$fechaInicioReal=NULL;}
        if($data['fechaFinReal']<>NULL){
            if($data['fechaInicioReal'] <> NULL){
                $this->validate($data, ['fechaFinReal' => "required|date|after_or_equal:$data[fechaInicioReal]"]);
            }
            $fechaFinReal=date("y/m/d H:i:s", strtotime($data['fechaFinReal']));
